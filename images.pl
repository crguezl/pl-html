...
$key = q/{center}vbox{input{chapter2slashregexp.tex}}{center};LFS=11;AAT/;
$cached_env_img{$key} = q|<IMG
 WIDTH="208" HEIGHT="15" ALIGN="BOTTOM" BORDER="0"
 SRC="|."$dir".q|img1.png"
 ALT="\begin{center}\vbox{\input{chapter2/regexp.tex}
}\end{center}">|; 
...
$key = q/%latex2htmlidmarker15850S=program;MSF=1.6;LFS=11;AAT/;
$cached_env_img{$key} = q|<IMG
 WIDTH="107" HEIGHT="32" ALIGN="MIDDLE" BORDER="0"
 SRC="|."$dir".q|img100.png"
 ALT="% latex2html id marker 15850
$ S = program$">|; 

...
$key = q/sectionpractica:conversordetemperaturasconkarmaytravis/;
...
$key = q/alg:parser/;
$external_latex_labels{$key} = q|5.12.1|; 
$noresave{$key} = "$nosave";
...
$key = q/alg:tables/;
$external_latex_labels{$key} = q|5.6.4|; 
$noresave{$key} = "$nosave";
